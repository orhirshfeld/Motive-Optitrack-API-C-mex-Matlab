...
/* The gateway function */
                  ...
                  int nrhs, const mxArray *prhs[])
 {
  ...
  const char project_file_name[130] = "c:\\Users\\sasson\\onedrive\\work control lab aero summer 2014 technion\\Motive-Optitrack-API-C-mex-Matlab-\\Motive.ttp";
   ...
   Sleep(500); //time in miliseconed
    for (i = 0; i < 20; i++)
    {
        ...
        mexEvalString("drawnow;"); //to output mexprintf now
